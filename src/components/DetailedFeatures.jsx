...
const featureData = [
  {
    ...
    description:
      "Get accurate text in real-time, as you speak. Frees you up to focus on the discussion, not note-taking.",
    points: [
  ...
  },
  {
    ...
    description:
      "See translated captions live. Language barriers dissolve, letting global teams collaborate with native-language ease.",
    points: [
  ...
  },
  {
    title: "AI Summary",
    description:
      "One-click meeting recaps. Automatically captures the core: key points, decisions, and next steps — so you can wrap your mind around it in minutes.",
    points: [
  ...
  },
  {
    title: "AI Chat",
    description:
      "Give your conversations a lasting memory and turn them into a searchable knowledge base. Ask your NIS AI about past calls, meetings, or lectures, and instantly find answers in your personal, searchable conversation archive.",
    points: [
  ...
  return (
    <section className="py-20 overflow-hidden">
      <div className="container mx-auto px-6">
        <div
          className={`flex flex-col ${feature.imageLeft ? "lg:flex-row-reverse" : "lg:flex-row"} items-center gap-12 lg:gap-20`}
        >
          {/* Text Content */}
          <motion.div
          ...
          >
            <div
              className={`absolute -inset-4 bg-gradient-to-tr ${feature.color} blur-3xl opacity-30 rounded-full`}
            />
      ...
      <div className="relative pt-24 pb-12">
        <div className="container mx-auto px-6 text-center mb-16">
          ...
          >
            ...
            <span className="text-gradient">Clearer Conversations</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            Everything you need to capture, understand, and recall every detail
            of your important discussions.
          </motion.p>
        </div>
